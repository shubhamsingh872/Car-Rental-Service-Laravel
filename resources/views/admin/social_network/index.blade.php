...
<div class="content">
    <div class="animated fadeIn"> <!-- Animated -->
        <div class="row">
            <div class="offset-sm-1 col-xs-10 col-sm-10">
                <div class="card">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="form-control" name="{{$row->name}}" value="{{$row->value}}" required></td>
                                        <td>
                                            <div class="checkbox">
                                                <input type="checkbox" id="{{$row->name}}_status" name="{{$row->name}}_status" checked="">
