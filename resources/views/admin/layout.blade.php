...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{url('/admin/bookings')}}"><i class="menu-icon fa fa-table"></i>Bookings</a>
                    </li>
                    <li>
                        <a href="{{url('/admin/carInventory')}}"><i class="menu-icon fa fa-car"></i>Car Inventory</a>
                    </li>
                    <li>
                        <a href="{{url('/admin/carTypes')}}"><i class="menu-icon fa fa-list"></i>Car Types</a>
                    </li>
                    <li>
                        <a href="{{url('/admin/extras')}}"><i class="menu-icon fa fa-plus"></i>Extras </a>
                    </li>
                    <li>
                        <a href="{{url('/admin/fuelTypes')}}"><i class="menu-icon fa fa-flask"></i>Fuel Types </a>
                    </li>
                    <li>
                        <a href="{{url('/admin/transmission')}}"><i class="menu-icon fa fa-sun-o"></i>Transmission </a>
                    </li>
                    <li>
                        <a href="{{url('/admin/locations')}}"><i class="menu-icon fa fa-globe"></i>Locations </a>
                    </li>
                    <li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <input type="text" hidden id="current-url" value="{{ Request::fullUrl() }}">
    </div>
    <!-- /#right-panel -->
